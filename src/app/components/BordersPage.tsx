      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '16px 16px 80px' }}>
        ...
        {loading ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[1,2,3,4].map(i => (
              <div key={i} style={{ height: 130, borderRadius: 20, background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)', border: '1px solid #0d1e30', animation: 'pulse 1.5s ease-in-out infinite' }} />
            ))}
          </div>
        ) : displayed.length === 0 ? (
