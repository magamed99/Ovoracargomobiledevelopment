                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                  <div>
                    ...
                    <AirportAutocomplete
                      ...
                      inputStyle={{ padding: '10px 12px', borderRadius: 10, border: '1px solid #ffffff10', background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)', fontSize: 13, fontWeight: 600 }}
                      showIcon={false}
                    />
                  </div>
                  <div>
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    ...
                    border: '1px solid #ffffff10', background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)',
