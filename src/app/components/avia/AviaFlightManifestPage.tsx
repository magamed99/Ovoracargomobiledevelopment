...
export function AviaFlightManifestPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)', fontFamily: "'Sora','Inter',sans-serif" }}>
      <motion.div
