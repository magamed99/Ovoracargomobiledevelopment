              ...
              <>
                ...
                <div className="fv-section" style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:20 }}>
                  <p style={{ fontSize:14, fontWeight:700, color:'#fff' }}>
                    Сохранённые рейсы
                    <span style={{ marginLeft:10, fontSize:11, fontWeight:800, padding:'3px 10px', borderRadius:100, background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)', color:'#5ba3f5' }}>{favorites.length}</span>
                  </p>
          ...
          <div className="fv-modal-overlay" onClick={() => setShowClearConfirm(false)}>
            <div className="fv-modal" onClick={e => e.stopPropagation()}>
              ...
              <div style={{ padding:'28px 28px 24px' }}>
                {/* Icon */}
                <div style={{ width:52, height:52, borderRadius:18, display:'flex', alignItems:'center', justifyContent:'center', background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px) saturate(160%)', WebkitBackdropFilter: 'blur(20px) saturate(160%)', marginBottom:16, borderWidth:1, borderStyle:'solid', borderColor:'#f43f5e30' }}>
