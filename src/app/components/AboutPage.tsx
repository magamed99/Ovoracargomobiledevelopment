      ...
      <div className="md:hidden flex flex-col min-h-screen max-w-3xl mx-auto">
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full" style={{ background: 'radial-gradient(circle, rgba(29,78,216,0.55), transparent 70%)', opacity: 0.22 }} />
            <div className="absolute top-16 -left-12 w-48 h-48 rounded-full" style={{ background: 'radial-gradient(circle, rgba(124,58,237,0.45), transparent 70%)', opacity: 0.30 }} />
          </div>
