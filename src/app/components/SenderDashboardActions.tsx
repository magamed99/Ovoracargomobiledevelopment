/**
 * SenderDashboardActions — быстрые действия на главном экране ОТПРАВИТЕЛЯ.
 ...
 */
import { Search, ClipboardList, Heart, ChevronRight } from 'lucide-react';
...
const ACTIONS = [
  {
    icon: Search,
    label: 'Найти поездку',
    sub: 'Поиск доступных рейсов',
    action: '/search',
    color: '#10b981',
    bg: '#10b98114',
    bgHover: '#10b98128',
    border: '#10b98130',
    borderHover: '#10b98160',
  },
  {
    icon: ClipboardList,
    label: 'Мои заказы',
    sub: 'История бронирований',
    action: '/trips',
    color: '#a855f7',
    bg: '#a855f714',
    bgHover: '#a855f728',
...
export function SenderDashboardActions() {
  const navigate = useNavigate();
  return (
    <>
